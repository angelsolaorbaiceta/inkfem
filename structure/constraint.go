...
// Constraint represents a condition on displacements and rotations.
...
// MakeConstraint creates a new constraint with the given degrees of freedom constrained of freed.
